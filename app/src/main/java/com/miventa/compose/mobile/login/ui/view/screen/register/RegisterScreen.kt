...
fun RegisterScreen(
    ...
    navigateToValidateRegister : () -> Unit = {},
) {
    ...
    val passwordConfirmState by rememberSaveable { mutableStateOf("") }
    var passwordConfirmHiddenState by rememberSaveable { mutableStateOf(true) }
    ...
    Box(
        ...
        Column(
            ...
            Text(
                ...
                text = "Here you can register a new account",
            )
            ...
            Text(
                modifier = modifier.fillMaxWidth(),
                style = MaterialTheme.typography.titleSmall,
                text = "Enter your password confirm",
            )
            PasswordTextField(
                password = passwordConfirmState,
                passwordHidden = passwordConfirmHiddenState,
                hint = "Password",
                imeAction = ImeAction.Done,
                onTextFieldChanged = { password ->
                    println(password)
                ...
                onClickPasswordHidden = {
                    passwordConfirmHiddenState = !passwordConfirmHiddenState
                },
            )
            ButtonPrimary(
                text = "Register",
