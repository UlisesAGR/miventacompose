...
import com.miventa.compose.mobile.miventa.login.domain.EmailVerifiedUseCase
import com.miventa.compose.mobile.miventa.login.domain.ValidateCurrentUserUseCase
...
class SplashViewModel @Inject constructor(
    ...
    private fun verifyCurrentUser() = viewModelScope.launch {
        ...
        validateCurrentUserUseCase()
            ...
            .onFailure {
                _splashUiEvent.emit(SplashUiEvent.Error(it))
            }
    }
